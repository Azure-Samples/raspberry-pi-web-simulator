...
Localization.localizedStringList = {
    ...
    "kr": {
        ...
        buttonStop: "Stop",
        buttonReset: "Reset",
        consoleWelcomeMessage: "`Run` 버튼을 클릭하면 샘플코드를 실행한다(샘플이 실행중일 때, 코드는 읽기전용이 됨).\n`Stop` 버튼은 샘플코드 시행을 멈춘다.\n`Reset` 은 코드를 초기화한다. 새로고침을 해도 편집된 코드는 유지된다.",
        consoleSampleStopped: "Sample stopped",
        connectionStringMissing: "Connection string is empty or error, please click 'Help' on the top-right to get help",
        codeEditor: "Code Editor",
        helpButton: "도움말",
        ...
        helpButtonNext: "다음",
        helpButtonGotIt: "확인",
        helpLinkSeeDoc: "문서 보기",
        helpLinkViewSource: "소스 보기",
        helpTitle1: "Raspberry Pi Simulator 살펴보기",
        helpTitle2: "Azure IoT hub 준비과정과 device connection string 확인하기",
        helpTitle3: "Pi web simulator에서 sample app 실행하기",
        helpContentAssemblyArea: "Assembly Area",
        helpContentCodingArea: "Coding Area",
        helpContentConsoleArea: "Integrated console window",
        helpContentAssemblyAreaDescription: "디바이스의 상태를 확인할 수 있다.",
        helpContentCodingAreaDescription: "Node.js를 이용해 Raspberry Pi 앱을 만들 수 있는 Online code editor이다.",
        helpContentConsoleAreaDescription: "앱의 output을 확인할 수 있다.",
        helpContentInThe: "",
        helpContentClick: "click",
        helpContentAdd: "Add",
        helpContentAzurePortal: "Azure portal",
        ...
        helpContentPane: "창에서",
        helpContent1: "New > Internet of Things > IoT Hub",
        helpContent2: "새로운 IoT hub를 provision 한다.",
        helpContent3: "Device Explorer",
        helpContent4: "IoT hub에 새로운 device를 추가한다.",
        helpContent5: "device를 선택해 새로 만들고 복사한다.",
        helpContent6: "(connection string의 primary key)",
        helpContent7: "Placeholder를 바꾼다",
        helpContent8: "(15번째 줄)",
        helpContent9: "- the Azure IoT hub",
        helpContent10: "의 device connection string으로",
        helpContent11: "button or type \"npm start\" in the console window to run the application",
        helpDocsLink: "https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-raspberry-pi-web-simulator-get-started",
        altRaspberryPiLogo: "Raspberry Pi logo"
    }
